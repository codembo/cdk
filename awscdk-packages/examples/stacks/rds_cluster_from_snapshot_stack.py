...
class RdsClusterFromSnapshotStack(Stack):
    ...
    def __create_rds_cluster(self, security_group):
        rds_cluster_from_snapshot_builder = RdsClusterFromSnapshotBuilder("RDS_Instance", self)
        ...
        rds_cluster_from_snapshot_builder.deletion_protection(False)
        ...
        rds_cluster_from_snapshot_builder.vpc(self.__vpc)
        rds_cluster_from_snapshot_builder.security_groups(security_group)

        return rds_cluster_from_snapshot_builder.build()
